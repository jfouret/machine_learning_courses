...
- **Task-specific intelligence**: Mastery in specific tasks, e.g., playing chess or solving mathematical problems.
- **Field-specific intelligence**: Expertise in a particular domain, such as medicine or music.
- **Emotional intelligence**: Ability to recognize, understand, and manage our own emotions and to recognize, understand, and influence the emotions of others. (Salovey & Mayer, 1990)
- **Social intelligence**: Ability to understand and navigate social situations and dynamics.
- **Creative intelligence**: Ability to produce novel and valuable ideas.
- **Practical intelligence**: Ability to solve real-world problems, often termed "street smarts".
...
- University exams (Bar exam, MAth exams)
- MAth challenge
