...
- Introduction : (1h30)
- I. Reminders and Foundations (2h30)

<p class="separator"><span>26/10 AM</span></p>

- TP (2h)
  - Data transformation / PCA
  - Maximum likelihood to fit distributions
  - Cross-entropy from ML demonstration
- II Base of Machine Learning 
  - A: Typology and nommenclatures (1h)
  - B: Evaluation metrics (1h)

TODO for next time -> Examples of ML algorithms
